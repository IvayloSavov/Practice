...
class Section:
    ...
    def add_task(self, new_task: Task):
        task_already_in = bool([task for task in self.tasks if task.name == new_task.name])
    ...
    def complete_task(self, task_name: str):
        task = [task for task in self.tasks if task.name == task_name]
    ...
    def clean_section(self):
        ...
        self.tasks = [t for t in self.tasks if t.completed is not True]
